...
public class BookingView implements View {
     ...
     * @param name            имя
     */
    public void changeReservationTable(Date oldReservation, int oldTableNo, Date reservationDate, int tableNo, String name){
        System.out.printf("Бронь успешно изменена: новая дата: " + reservationDate + " (старая: " + oldReservation + "); новый стол: " + tableNo + " (старый: " + oldTableNo + "); имя: " + name);
    }
